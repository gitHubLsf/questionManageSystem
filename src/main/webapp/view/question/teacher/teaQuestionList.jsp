        ...
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                ...
                <shiro:hasPermission name="file_import_question">
                    <button class="layui-btn layui-btn-radius" data-type="fileAddByTeacher">文件导入</button>
                </shiro:hasPermission>
...
<script>
    layui.config({
        ...
        var active = {
            ...
            }, fileAddByTeacher: function () {    // 教师从文件导入错题
                layer.open({
                    type: 2
                    , title: '从word文档导入错题'
                    , content: '/view/question/teacher/uploadQuesTea.html'
                    , maxmin: true
                    , area: ['850px', '550px']
                    , btn: ['确定', '取消']
                    , yes: function (index) {
