    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                ...
                <button class="layui-btn layui-btn-radius" data-type="manAdd">手动添加</button>
                <shiro:hasPermission name="file_import_question">
                    <button class="layui-btn layui-btn-radius" data-type="fileAddByStudent">文件导入</button>
                </shiro:hasPermission>
                <shiro:hasPermission name="ocr_import_question">
...
<script>
    layui.config({
        ...
        table.on('tool(LAY-user-back-manage)', function (obj) {
            ...
            } else if (obj.event === 'edit') { // 修改错题
                var id = obj.data.id;
                layer.open({
                    type: 2
                    , title: '修改错题'
                    , content: '/question/update/' + id
                    , shadeClose: true
                    , maxmin: true
        ...
        var active = {
                        ...
                        success: function (res) {
                            ...
                            if (res.code === 0) {
                                layer.confirm('确定删除这些错题吗？', function (index) {
                                    $.ajax({
                                        url: "/question/batchDelete/person",
                                        data: {"ids": idArr},
                                        traditional: true
                                    });
                                    table.reload('LAY-user-back-manage', {
            ...
            , fileAddByStudent: function () {    // 从文件导入错题
                layer.open({
                    type: 2
                    , title: '从文档导入错题'
                    , content: '/view/question/student/uploadQuesStu.html'
                    , maxmin: true
                    , area: ['850px', '550px']
                    , btn: ['确定', '取消']
                    , yes: function (index) {
